...
const formSchema = z.object({
    ...
    confirmPassword: z.string().min(1, { message: "Password is required" }),            //we are asking for new password
})
.refine((data)=>data.password===data.confirmPassword,{   
    message: "Password don't match",
    path:["confirmPassword"],
});
{/*Checks if the passord and confirm password is coorect */}
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="text-center text-sm">
                  Already have an account?<Link href="/sign-in" className="underline underline-offset-4">     {/*cant put apostofi directlt-ERROR */}
                    Sign in
                  </Link>
                </div>
              </div>
